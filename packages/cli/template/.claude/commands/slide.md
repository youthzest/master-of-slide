...
- If image generation is available, use `create-slide-image-prompts` to create suitable image prompts and assets.
- If image generation is unavailable, leave precise `ImagePlaceholder` hints and report the prompts.
