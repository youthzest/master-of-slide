    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          'overflow-x-hidden overflow-y-auto rounded-[2px] border-2 border-foreground bg-popover p-1 text-popover-foreground shadow-floating',
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'relative flex cursor-default items-center gap-2 rounded-[1px] border-2 border-transparent px-2 py-1.5 text-[12.5px] font-bold outline-hidden select-none transition-colors',
        'focus:border-foreground focus:bg-secondary focus:text-foreground',
        'data-[active=true]:border-foreground data-[active=true]:bg-accent data-[active=true]:text-foreground',
